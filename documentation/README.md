...
| 4 | [Products & layout](./04-products-and-layout.md) | Pulse, Flow, Command, Desk, Apex; toolbars |
| 5 | [Props & chart options](./05-props-and-chart-options.md) | `SimpleChartEdge` / `ChartEdgeHost`, `chartOptions`, themes |
